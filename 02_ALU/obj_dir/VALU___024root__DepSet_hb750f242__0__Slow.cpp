...
#endif
            VL_FATAL_MT("generated-src/ALU.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VALU___024root___ctor_var_reset(VALU___024root* vlSelf) {
    ...
    vlSelf->io_operandA = VL_RAND_RESET_I(32);
    vlSelf->io_operandB = VL_RAND_RESET_I(32);
    vlSelf->io_operation = VL_RAND_RESET_I(4);
    vlSelf->io_aluResult = VL_RAND_RESET_I(32);
}
